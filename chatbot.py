...
flag = True
print("Elsa: My name is Elsa. I will answer your queries about Chatbots. If you want to exit, type Bye!")
while flag:
    ...
    if user_response != 'bye':
        if user_response in ('thanks', 'thank you'):
            flag = False
            print("Elsa: You're welcome.")
        else:
            if greeting(user_response) is not None:
                print("Elsa: " + greeting(user_response))
            else:
                print("Elsa: " + response(user_response))
                sent_tokens.remove(user_response)
    else:
        flag = False
        print("Elsa: Goodbye!Feel free to come back if you have more questions.")
